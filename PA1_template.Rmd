...
The mean number of steps per day is `r MeanTS` and the median number of steps per day
is `r MedTS`. 
...
The max average steps per days occurs at time interval `r x`.
...
The total number of NA values is `r TotalNA`. 
...
The new mean number of steps per day is `r MeanTSNoNA` and the median number of steps per day
is `r MedTSNoNA`.

Comparing the number recall that the original mean was `r MeanTS` and the original median was `r MedTS`. 
